...
/**
 * Mock jenkins server to confirm correct job request
 * method: POST
 * url: http://localhost:8087/job/repoName branchName/build
 *
 */
...
app.post('/job/repoName%20branchName/build', function (req, res, next) {
